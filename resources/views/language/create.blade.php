...
@section('content')
 <div class="container bg-light p-5">
   ...
   <div class=" my-3 ">
    <form method="POST" action="{{url('dashboard/languages/')}}"  enctype="multipart/form-data">
       @csrf
       @method('POST')
           <div class="row">
              <div class="col-6 my-2"> 
                 <label for="title">Title</label>
                 <input  type="text" class="rounded @error('title') is-invalid  @enderror form-control form-control-sm" id="title" name="title" value="{{ old('title') }}">
              @error('title')
              ...
              <div class="col-6 my-2"> 
               ...
               <input  type="text" class="rounded @error('slogan') is-invalid  @enderror form-control form-control-sm" id="slogan" name="slogan" value="{{ old('slogan') }}">
            @error('slogan')
               <small class="fw-bold   text-danger">{{ $message }}</small>
            @enderror
            </div>
